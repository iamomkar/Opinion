package com.creativeminds.opinion.utils;
...
public class AadhaarXMLParser {
    ...
    private AadharCard aadhaarCard;

    public AadharCard parse(String xmlContent) throws XmlPullParserException, IOException {
        InputStream in = new ByteArrayInputStream(xmlContent.getBytes());
        aadhaarCard = new AadharCard();
